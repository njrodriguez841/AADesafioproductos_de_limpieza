...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light border border-warning"
		style="background:rgb(4, 247, 113);;">
	...
	<section class="container">
		...
		<form action="modificarProducto" method="post">
			<input type="hidden" class="form-control" id="id_producto"
				...
				for="nombre_producto" class="form-label">Ingrese nuevo
				...
				for="precio_producto" class="form-label">Ingrese nuevo
				Precio: </label> <input type="number" class="form-control"
				id="precio_producto" name="precio_producto"
				value="${producto.precio_producto}"> <br> <label
				for="descripcion_producto" class="form-label">Ingrese
				nueva Descripción: </label> <input type="text"
				class="form-control" id="descripcion_producto"
				name="descripcion_producto" value="${producto.descripcion_producto}">
			<br> <label for="id_categoria" class="form-label">Seleccione
				nueva Categoría: </label> <select name="id_categoria"
				id="id_categoria">
